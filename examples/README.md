...
* **Pipeline:** Borrowed from the Unix command line, this pattern
...
| pipeline                                  | [Rust](rust/pipeline)                                                                                                                                                                            | Staged ordered processing with ingress, worker, and egress roles where each worker transforms and forwards samples to the next stage.                                                                             |
