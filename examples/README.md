...
* **Blackboard:** This pattern realizes a key-value store in
  shared memory which can be modified by one or more writers and several readers.
...
| ------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| blackboard                                 | [C](c/blackboard) [C++](cxx/blackboard) [Python](python/blackboard) [Rust](rust/blackboard)                                                                                                     | Unidirectional communication where one or more writers update data in an inter-process key-value store, called the blackboard, which several readers can read.                                                  |
...
| custom_vocabulary_types                    | [C++](cxx/custom_vocabulary_types)                                                                                                                                                              | How to use custom vocabulary types for the C++ bindings. In addition to be able to use C++ STL types, the `iox2::bb::Expected` and `iox2::bb::Optional` can be replaced with custom implementations.            |
